...
% TODO add a small section on replacing EitherT with better more structured
% error reporting.
% This structured error type would list out the operation the error occurred in
