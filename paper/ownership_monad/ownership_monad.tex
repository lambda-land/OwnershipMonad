...
the \textit{Onwership Moand}.  These operations will verify whether the
...
and duplicated - this doubles the space and creates a new resource.
A moved resource doesn't change - instead what is altered is the record of who
owns that resource. Neither operation, moving and copying, creates a situation
where more than one reference owns a resource.
