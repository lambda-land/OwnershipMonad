...
what is called an Owned reference (an \texttt{ORef}) can be used.
...
rules facilitates offers significant improvements in specific areas.
...
this there is no inherent state.  Haskell's purity allows for referential
