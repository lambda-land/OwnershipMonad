...
expression it is given and will print debuggin information to standard output
...
Instead of having to remember what order to acquire locks, the owned references
...
within the scope of the monad which owns the \texttt{ORef}.
